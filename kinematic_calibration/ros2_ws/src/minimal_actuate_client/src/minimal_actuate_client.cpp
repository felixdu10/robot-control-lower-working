...
int main()
{
  try {
    ...
    std::vector<std::array<float, 4>> test_configs = {
      ...
      {10.0f, 5.0f, 20.0f, 15.0f},
      {15.0f, 20.0f, 5.0f, 10.0f},
      {20.0f, 15.0f, 10.0f, 5.0f},

      {5.0f, 15.0f, 10.0f, 20.0f},
      {10.0f, 20.0f, 5.0f, 15.0f},
      {15.0f, 5.0f, 20.0f, 10.0f},
      {20.0f, 10.0f, 15.0f, 5.0f},

      {5.0f, 20.0f, 10.0f, 15.0f},
      {10.0f, 15.0f, 5.0f, 20.0f},
      {15.0f, 10.0f, 20.0f, 5.0f},
      {20.0f, 5.0f, 15.0f, 10.0f}
    };
