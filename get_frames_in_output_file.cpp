 ...
 *
 *   \file get_frames_in_output_file.cpp
 *   \brief get two frames, the F_OM1 and F_OM1
 *
...
int main( int argc, char** argv )
{
    ...
    cout << "This is a program that outputs frames of two markers to a file in real time"
         << endl;
